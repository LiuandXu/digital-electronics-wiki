...
graph TD
    ...
    D --> D1["三极管开关特性<br>截止/放大/饱和/倒置"]
    D --> D2["电路结构<br>输入级/中间级/输出级"]
    D --> D3["典型门<br>与非/或非/与或非/异或"]
    D --> D4["输出形式<br>图腾柱/OC/三态"]
    
    E --> E1["MOS管开关特性<br>静态/动态"]
    E --> E2["CMOS反相器<br>P管+N管互补"]
    E --> E3["传输门<br>模拟开关/异或门"]
    E --> E4["CMOS门结构<br>P并N串(与非)/N并P串(或非)"]
    E --> E5["OD门/三态门"]
    E --> E6["特点: 微功耗/宽电压/高阻抗"]
